...
Вы можете установить или обновить правила в своем проекте с помощью скриптов установки. Скрипты инъектируют инструкции воркфлоу в файлы `AGENTS.md`, `CLAUDE.md` и `GEMINI.md`, сохраняя ваши собственные правила.
...
You can install or update the rules in your project using the installation scripts. These scripts inject workflow instructions into `AGENTS.md`, `CLAUDE.md`, and `GEMINI.md` while preserving your custom rules.
